...
uint256 hashGenesisBlock("0x8018e19461ed39492b40fe184c32630191f51d4a54352065b9017e6d124d10b6");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // EUNCoin: 3.5 days
static const int64 nTargetSpacing = 2 * 60; // EUNCoin: 2.5 minutes
...
{
    // EUNCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8018e19461ed39492b40fe184c32630191f51d4a54352065b9017e6d124d10b6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "OneSpace launches country’s first privately built rocket.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04e31349d862e682ccd26f22f34ce3fdaa4ec0b2f94a9b94885966accb35ff524d1d43e512a8a9671c785acb64dc0215890f08a1d46c0beec7ea8b7f5fd886fe04") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1527405441;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1695385;
        ...
        assert(block.hashMerkleRoot == uint256("0x4b52a108e36214fa28d11e86fb7b0f82b4aabeac608a634d260cd3d718d6e065"));
...
unsigned char pchMessageStart[4] = { 0xfd, 0xc2, 0xb1, 0xdd }; // EUNCoin: increase each by adding 2 to litecoin's value except third.
